...
const { replaceAllInList } = require('../util/replaceAll.js')
...
module.exports = {
    async fetchData() {
        ...
        for (var sheetIndex = 0, sheetLength = Object.keys(sheetsData).length; sheetIndex < sheetLength; sheetIndex++) {
            ...
            // Add sheetName to extraData
            if (sheetName != 'sheet7' && sheetName != 'credits') {
                extraData.sheets.push(sheetName)
            }
        ...
        // Write to file
        const dataFilePath = 'res/latest.data.json'
